  ...
  return (
    <Card className="shadow-sm">
      ...
      <CardContent className="space-y-6 pt-6">
        {currentUserId && (
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20 p-4 rounded-lg border border-blue-100 dark:border-blue-900">
